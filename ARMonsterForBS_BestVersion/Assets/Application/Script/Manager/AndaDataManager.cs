...
public class AndaDataManager  {
    ...
    {
        networkController.GetServerMessage(callback);
    }
    #endregion
    ...
    {
        networkController.GetPlayerCoupon(callback);
    }
    ...
    public void FailPlayerCoupon(int applyIndex, System.Action<PlayerCouponRequest> callback)
    {
        networkController.FailCoupon(applyIndex, callback);
    }
    public void QRCheackCoupon(string QR, System.Action<PlayerCouponRequest> callback)
    {
        networkController.QRCheackCoupon(QR, callback);
    }
    #endregion
